FILES = ./build/kernel.asm.o ./build/kernel.o ./build/idt/idt.asm.o ./build/idt/idt.o ./build/memory/memory.o ./src/icps/target/i686-unknown-linux-gnu/release/libicps.a
INCLUDES = -I./src
